...
function Get-CheatSignatures {
    return @(
        "meteorclient","wurstclient","aristois","futureclient","rusherhack","impact","baritone","xenon","kypton","argon","walksy","osmium","gypsyy","Sakurwa","Lucid Argon","optimizer","macro","anchorhack","Glazed"
    )
}
